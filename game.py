...
def game(num_task,user):
    ...
    print ("Guess a number i.e between 1 to 5")
...
def task1(num_task,user):
    ...
    print('\n')
    print('TASK 1')
    print('INFO : In this task the program converts a Hidden word to hex format.')
    print('       To find out the hidden word you may have write a program that converts')
    print('       the hex back to string. GOOD LUCK!!')
    print('\n')
    print('----------------------------------')
    print('\n')
    numbers = []
...
def task2(num_task,user):
    ...
    print('\n')        
    print('TASK 2')
    print('INFO : This is a pretty simple task. If you were not-able/able to solve the TASK 1')
    print('       this would be very easy task compared to TASK 1')
    print('\n')
    print('----------------------------------')
    print('\n')
...
def task3(num_task,user):
    ...
    print('\n')
    print('TASK 3')
    print('INFO : This is about yourf knowledge in mathematics. ')
    print('       An Armstrong number is a number such that the sum of its digits raised ')
    print('       to the third power is equal to the number itself')
    print('\n')
    print('----------------------------------')
    print('\n')
...
def task4(num_task,user):
    ...
    print('\n')
    print('TASK 4')
    print('INFO : This task uses a string and converts the string into a SHA-256 hash.')
    print('       Hash is a method that is used to store passwords in databases.')
    print('       Hash is a single way process, so your might have to create program that cracks this hash')
    print('\n')
    print('----------------------------------')
    print('\n')
...
def task5(num_task,user):
    ...
    print('\n')
    print('Task 5')
    print('INFO : Just count the number of patterns')
    rows = 8
